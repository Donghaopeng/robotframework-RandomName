...
last_names2 = ['欧阳', '太史', '端木', '上官', '司马', '东方', '独孤', '南宫', '万俟', '闻人', '夏侯', '诸葛', '尉迟', '公羊', '赫连', '澹台',
...
def last_name2():
    ...
    :return: 
    """
    return last_names2[random.randrange(0, len(last_names2))]
...
def last_name1():
    ...
    :return: 
    """
    return last_names[random.randrange(0, len(last_names))]
...
def get_name():
    ...
    """
    len_name = [2, 3, 4]
    case_number = len_name[random.randrange(0, len(len_name))]
    if case_number == 2:
        name = '{}{}'.format(last_name1(), first_name())
    if case_number == 3:
        name = '{}{}{}'.format(last_name1(), first_name(), first_name())
    if case_number == 4:
        name = '{}{}{}'.format(last_name2(), first_name(), first_name())
