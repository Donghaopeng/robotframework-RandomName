...
class RandomName():
    ...
    def __last_name2(self):
        """
        获得的姓氏是复姓
        :return:
        """
        return self.__get_random_list_value(self.__last_names2)

    def __last_name1(self):
        """
        获得的姓氏为单姓
        :return:
        """
        return self.__get_random_list_value(self.__last_names)
    ...
    def __first_name(self):
        ...
        :return:
        """
        return self.__get_random_list_value(self.__first_names)

    def get_name(self):
        """
        获得全名，全名包括的名字格式：2位数名字**，3位数名字***，4位数名字****
        :return:
        """
        len_name = [2, 3, 4]
        case_number = self.__get_random_list_value(len_name)
        if case_number == 2:
            name = '{}{}'.format(self.__last_name1(), self.__first_name())
        if case_number == 3:
            name = '{}{}{}'.format(self.__last_name1(), self.__first_name(), self.__first_name())
        if case_number == 4:
            name = '{}{}{}'.format(self.__last_name2(), self.__first_name(), self.__first_name())
        return name


    def __get_random_list_value(self, list_object):
